...
Ever wanted to draw your imagination by just waiving your finger in air. Air Canvas which can draw anything on it by just capturing the motion of a coloured marker with camera. Here a coloured object at tip of finger is used as the marker.
...
3. Run "python air-canvas.py" command and hit enter. 
4. To Exit Press "q".